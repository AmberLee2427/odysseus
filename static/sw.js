...
// Strategy:
//   - HTML (navigation): network-first, cache fallback. Deploys need the new
//     HTML asset URLs on the *first* reload, not a second mystery refresh.
...
const CACHE_NAME = 'odysseus-v398';
...
const PRECACHE = [
  '/',
  '/static/style.css',
  '/static/manifest.json?v=boat-1',
  '/static/icon-192.png?v=boat-1',
  '/static/icon-512.png?v=boat-1',
  '/static/app.js',
...
self.addEventListener('fetch', (e) => {
  ...
  // HTML navigation: network-first for the SPA root. A cached root was making
  // deploys appear to do nothing until a second navigation refreshed its old
  // script URLs in the background.
