...
_TIMEOUT_EXEMPT_PREFIXES = (
    ...
    "/api/browser/summarize",  # browser page summaries have their own model timeout
)
...
from routes.logseq_routes import setup_logseq_routes
app.include_router(setup_logseq_routes())
