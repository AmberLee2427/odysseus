...
async def execute_tool_block(
    ...
    from src.tool_implementations import (
        ...
        do_manage_calendar, do_manage_logseq, do_manage_latex_projects,
    ...
    elif tool == "manage_logseq":
        desc = "manage_logseq"
        result = await do_manage_logseq(content, owner=owner)
    elif tool == "manage_latex_projects":
        desc = "manage_latex_projects"
        result = await do_manage_latex_projects(content, owner=owner)
